...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      if ($mes != "") {
         $titulo = "REPORTE DE ENTRADAS DEL MES DE: " . $mes;
      }
      if ($ano != "") {
...
if ($fecha != "") {
   ...
   $query = "SELECT * FROM entradas where FechaRegistro='$fecha'";
...
if ($mes != "") {
   ...
   $query = "SELECT * FROM `entradas` WHERE MONTH(entradas.FechaRegistro) = $mes;";
   $resul = mysqli_query($conn, $query);
...
if ($ano != "") {
   ...
   $query = "SELECT * FROM `entradas` WHERE YEAR(entradas.FechaRegistro) = $ano;";
   $resul = mysqli_query($conn, $query);
...
if ($ano != "" and $mes != "") {
   ...
   $query = "SELECT * FROM `entradas` WHERE MONTH(entradas.FechaRegistro) = $mes AND YEAR(entradas.FechaRegistro)= $ano;";
   $resul = mysqli_query($conn, $query);
