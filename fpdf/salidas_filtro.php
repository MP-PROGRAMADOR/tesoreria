...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      if ($mes != "") {
         $titulo = "REPORTE DE SALIDAS DEL MES DE: " . $mes;
      }
      if ($ano != "") {
...
if ($mes != "") {
   ...
   $query = "SELECT * FROM `salidas` WHERE MONTH(entradas.FechaRegistro) = $mes;";
   $resul = mysqli_query($conn, $query);
...
if ($ano != "") {
   ...
   $query = "SELECT * FROM `salidas` WHERE YEAR(entradas.FechaRegistro) = $ano;";
   $resul = mysqli_query($conn, $query);
...
if ($ano != "" and $mes != "") {
   ...
   $query = "SELECT * FROM `salidas` WHERE MONTH(entradas.FechaRegistro) = $mes AND YEAR(entradas.FechaRegistro)= $ano;";
   $resul = mysqli_query($conn, $query);
