                            ...
                            <div class="card-body">
                              <div class="d-sm-flex justify-content-between align-items-start">
                                <div>
                                  ...
                                  <p class="card-subtitle card-subtitle-dash">estadistica del registro de entrada y
                                    salidas</p>
                                </div>
                                    ...
                                    while ($row_usuarios = $resultado_usuario->fetch_assoc()) {
                                      ...
                                      <tr>
                                        <td>
                                          <div class="d-flex">
                                            <img
                                              src="data:image/*;base64,<?php echo base64_encode($row_usuarios['Foto']); ?>"
                                              alt="" height="50px">
                                            <div>
                                          ...
                                          <div>
                                            ...
                                            <div class="progress progress-md">
                                              <div class="progress-bar bg-success" role="progressbar"
                                                style="width: <?php echo $resulDivE; ?>%" aria-valuenow="25"
                                          ...
                                          <div>
                                            ...
                                            <div class="progress progress-md">
                                              <div class="progress-bar bg-danger" role="progressbar"
                                                style="width: <?php echo $resulDivS; ?>%" aria-valuenow="25"
                                                aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                          </div>
                                        </td>
                                        ...
                                        <div class="form-check w-100">
                                          <label class="form-check-label">
                                            <input class="checkbox"
                                              type="checkbox"><?php echo $fila['Descripcion']; ?><i
                                              class="input-helper rounded"></i>
                                          </label>
                                          <div class="d-flex mt-2">
                                            <div class="ps-4 text-small me-3"><?php echo $fila['FechaRegistro']; ?>
                                            </div>
                                            <div class="badge badge-opacity-warning me-3">Numero:
                                              <?php echo $fila['NumRegistro']; ?>
                                            </div>
                              ...
                              <div class="row">
                                <div class="col-lg-12">
                                  ...
                                  <div class="mt-3">
                                    ...
                                    <div class="form-check w-100">
                                      <label class="form-check-label">
                                        <input class="checkbox" type="checkbox"><?php echo $fila2['Descripcion']; ?><i
                                          class="input-helper rounded"></i>
                                      </label>
                                      <div class="d-flex mt-2">
                                        <div class="ps-4 text-small me-3"><?php echo $fila2['FechaRegistro']; ?></div>
                                        <div class="badge badge-opacity-warning me-3">Numero:
                                          <?php echo $fila2['NumRegistro']; ?>
                                        </div>
                                        <i class="mdi mdi-flag ms-2 flag-color"></i>
                                      </div>
